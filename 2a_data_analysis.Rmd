...
Because simple linear regression model has some limitations, this study adds the date variable to create a linear mixed model, explores the impact of wind load on the collision rate on different dates.
