...
# of some species (not just light intensity)... Account for this eventually, 
# either by acknowledging or including in regression model (date as random
# effect)...
...
# But actually slightly better with log transform. Does GLM do this? log link? yes? 

# Plot log-transformed data from LM to see if potential effect of light intensity on collisions? 
